...
import { BiSearch, BiVideo, BiPhone } from "react-icons/bi";
...
const MessageHead: FC<MessageHeadProps> = ({ name, online }) => {
  return (
    <div className="w-full p-4 flex items-center justify-between bg-light-grey-bg dark:bg-dark-grey-bg">
      <div className="flex items-center">
        ...
        />
        <div>
          <p className="font-bold text-dark-moon dark:text-light-moon">{name}</p>
          <p className="text-sm text-dark-grey-text dark:text-light-text">
